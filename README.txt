...
Input files: 'datainput_files' folder
...
WRF input files: 'pre_analysis_wrf_input_files' folder
1) i_dec27tojun18.mat
2) iwrf_spatial_dec17tojun18.mat
3) wrf_raw17to18.mat
These three files are used for the analysis of WRF forecasts.
...
Required files: 
i) WRF forecasts in the folder 'pre_analysis_wrf_input_files'
ii) simulated results in the folder 'result_files'
