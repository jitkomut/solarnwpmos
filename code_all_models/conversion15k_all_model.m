...
% mos hourly
[hourly_mos_train.perf_p,hourly_mos_train.perf_p_specific]=performance_index_pv(hourly_mos_train.Phat(end-4559:end),p_train,install_cap);
[hourly_mos_test.perf_p,hourly_mos_test.perf_p_specific]=performance_index_pv(hourly_mos_test.Phat,p_test,install_cap);
...
% kf3
[hourly_kf3_train.perf_p,hourly_kf3_train.perf_p_specific]=performance_index_pv(hourly_kf3_train.Phat(end-4559:end),p_train,install_cap);
[hourly_kf3_test.perf_p,hourly_kf3_test.perf_p_specific]=performance_index_pv(hourly_kf3_test.Phat,p_test(horizon*2+1:end),install_cap);
